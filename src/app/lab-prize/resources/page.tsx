...
export default async function PrizeResourcesPage() {
  const pageId = process.env.NOTION_PRIZE_RESOURCES_PAGE_ID;
  ...
  h(
    ...
    h(
      ...
      : h(
        ...
        'Content is empty. Add content to the "Prize Resources" page in Notion.'
        )
      )
    )
  );
