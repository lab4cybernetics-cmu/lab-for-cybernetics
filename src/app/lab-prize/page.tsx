...
export default async function LabPrizePage() {
    ...
    // headerParagraphs[0] = info (left side)
    // headerParagraphs[1] = info (right side)
                    ...
                    <SectionWithLinkTooltip docs={definingDocs}>
                        <section>
                            {contentBlocks.length > 0 ? (
                                ...
                                <div className="text-neutral-500 italic mt-8">Content is empty.</div>
                            )}
                        </section>
